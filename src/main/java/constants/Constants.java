...
public class Constants {
	...
	public final static String User_add ="insert into Users1(USER_NAME, User_#, Major, PHONENUM) values(?,?,?,?)";
	public final static String User_getList ="SELECT USER_#, USER_NAME, MAJOR, PHONENUM, JOINDATE, STATUS FROM Users1 WHERE NOT STATUS='PERMIT' ORDER BY STATUS, Major";
	...
	public final static String LogedOn = "SELECT DECODE(Count(*), 1, 'true', 'false') AS RESULT FROM USERS1 WHERE User_#=?";
}
